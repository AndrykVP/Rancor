            ...
            <div class="card-body">
               <form action="/forums/replies" method="POST">
                  ...
                  <div class="form-group">
                     ...
                     <textarea rows="5" class="form-control" name="body" id="body" aria-describedby="bodyHelp">{{ $quote ? '<blockquote>'.$quote->body.'</blockquote>' : '' }}</textarea>
                     @error('body')
