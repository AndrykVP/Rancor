         ...
         <div class="inline-flex mt-4 md:mt-0">
            <form class="mr-4" action="{{ route('admin.'.$resource['route'].'.search') }}" method="POST">
               ...
               <div class="relative text-gray-600">
                  <input type="search" name="search" placeholder="Search by name..." class="bg-white h-10 px-5 pr-10 rounded-full border-gray-300 text-sm focus:border-indigo-300 focus:outline-none">
